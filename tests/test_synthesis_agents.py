...
class TestKnowledgeGraph:
    ...
    def test_identify_divergences(self):
        ...
        assert any(d["perspective"] == ResearchPerspective.O3.value for d in divergences)
...
class TestResearchDigestionAgent:
    ...
    async def test_process_research_file(self):
        ...
        insights = await agent._process_research_file(
            file_path,
            ResearchPerspective.O3
        )
...
class TestProcessSigmaBuilderRequest:
    ...
    async def test_process_full_workflow(self):
        ...
        request = TaskRequest(
            description="Execute full workflow"
        )
    ...
    async def test_process_error_handling(self):
        ...
        request = TaskRequest(
            description="Execute invalid phase",
            phase="invalid_phase"
        )
